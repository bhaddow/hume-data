...
sentences, but ignored by HMEANT.
...
In HMEANT, there are no guidelines as to when to propagate an error. In HUME,
errors are localised as much as possible to where they occur,
by the separation of atomic and structural nodes.
This allows us to calculate more accurately the total score of the sentence.
