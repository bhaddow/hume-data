...
This section summarises the procedure for annotation involved in computing HUME. We mark
the source sentence as $s$ and the translation sentence as $t$. 
...
\item One of the sub-units is missing from the translation. For instance, if ``dog bites man''
  is translated into ``dog bites''.
\end{compactitem}
