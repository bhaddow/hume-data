...
When a multi-word unit is labeled as atomic, its sub-units' annotations are discarded
from the evaluation.
...
We now describe the HUME annotation interface, shown in Figure~\figref{fig:interface}. 
...
``Schwangerschaft ... laufenden'' (lit. ``pregnancy ... ongoing''). The interleaving 
