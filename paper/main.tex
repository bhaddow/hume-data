...
\end{tabular}
\caption{Inter-annotator agreement for the multiply-annotated portions of the data,
...
taken alone, captures the crux of the sentence semantics meanings.\oa{do we mention here that
  Scenes in their own right correlate less with DA? maybe we should distinguish verbal and non-verbal
  scenes?} Consider the example:
...
This omission will not be taken into account by HMEANT at all\footnote{Argument structures and linkers are explicitly marked in UCCA. Non-auxiliary instances of ``be'' and nouns are identified using the NLTK standard tagger. Nominative argument structures are defined as Scenes whose main relation is headed by a noun.}.
