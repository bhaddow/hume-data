...
\begin{figure*}[t]
\begin{tikzpicture}
\node(tree) [] {\includegraphics[width=1\textwidth]{tree_653_de1_de2.pdf}};
\node [below right = -2cm and  -8cm of tree]{\includegraphics[width=0.4\textwidth]{DAline-extract.png}};
\end{tikzpicture}
%\begin{tabular}{c}
