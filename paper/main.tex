...
\caption{Pearson correlation HUME scores vs DA for different node types. Struct refers to all structural nodes, P+S are all process and state nodes, H parallel scene nodes, A participant, C centre, E elaborators, and L linker nodes.}
