...
according to conservative estimates that only considers non-auxiliary instances of ``be''.
\\
...
sentences\footnote{Argument structures and linkers are explicitly marked in UCCA. We identified non-auxiliary instances of ``be'' and nouns using the NLTK standard tagger. Nominative argument structures are here defined as Scenes whose main relation is headed by a noun.}.
\end{inparadesc}
...
errors are localised as much as possible to where they occur, by the separation of atomic and structural nodes. This allows us to calculate more accurately the total score of the sentence.
