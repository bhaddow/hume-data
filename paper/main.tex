...
\\
\item[Nominal argument structures,] which are completely ignored under HMEANT, are in fact highly
...
In HMEANT, there are no guidelines as to when to propagate and error. In HUME,
errors are localised as much as possible to where they occur, by the separation of atomic and structural nodes. This allows us to calculate more acurately the total score of the sentence.
