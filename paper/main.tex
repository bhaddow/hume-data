...
\begin{figure*}
  ...
  child {node (H3) [label={A}] [fill=yellow,circle] {}
    ...
    child {node (H1) [label={O}] [fill=orange,circle] {}
    ...
    child {node (H2) [label={A}] [fill=yellow,circle] {}
      ...
      child {node {} edge from parent[draw=none] {}}
      child {node {} edge from parent[draw=none] {}}
      child {node [label={}] {for} edge from parent node[left]  {}}
      child {node [label={}] {his} edge from parent node[left]  {}}
      child {node [label={}] {oldest} edge from parent node[left]  {}}
      child {node [label={}] {daughter} edge from parent node[left]  {}}
    }
  }
  child {node {} edge from parent[draw=none] {}}
  child {node (H4) [label={A}] [fill=yellow,circle] {}
    child {node [label={}] {she} edge from parent node[left]  {}}
      child {node [label={}] {attended} edge from parent node[left]  {}}
      child {node [label={}] {daily} edge from parent node[left]  {}}
      child {node [label={}] {lesssons} edge from parent node[left]  {}}
  }
  child {node [label={}] {and} edge from parent node[left]  {}}
  child {node (H5) [label={A}] [fill=yellow,circle] {}  
    child {node [label={}] {greatly} edge from parent node[left] {}}
    child {node [label={}] {improved} edge from parent node[left] {}}
  };
