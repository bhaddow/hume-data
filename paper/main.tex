...
\author{
Alexandra Birch\textsuperscript{1}, Barry Haddow\textsuperscript{1}, Ond{\v{r}}ej Bojar\textsuperscript{2}, Omri Abend\textsuperscript{3}\\
\textsuperscript{1}School of Informatics, University of Edinburgh\\
\textsuperscript{2}Institute of Formal and Applied Linguistics, Charles University in Prague\\
\textsuperscript{3}School of Computer Science and Engineering, Hebrew University of Jerusalem\\
\texttt{a.birch@ed.ac.uk, bhaddow@inf.ed.ac.uk}\\
\texttt{bojar@ufal.mff.cuni.cz, oabend@cs.huji.ac.il}\\
}
