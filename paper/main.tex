...
marked as ``Red''. The root node still has two scenes linked by one linker and there relationship between child nodes is maintained and therefore it is marked ``Adequate''. In HMEANT it is not clear whether errors should be propegated up the SRL hierarchy. 
...
Überprüfung\dots} (lit. \equo{This review}). The omission is not by HMEANT at
all.
