...
e.g., in the WMT tasks \cite{bojar2015findings}, or by giving
...
\newcite{gimenez2007linguistic} proposed to combine multiple types of information,
...
\cite{Dixon:10a,Dixon:10b,Dixon:12}.
...
\cite{sulem2015conceptual}. This indicates that the scheme reflects
...
First, the annotation process is different. In HUME, we semantically annotate the
source, then automatically project it to the translation, and ask bilingual
annotators to assess the quality of the projected translation. In
HMEANT, they semantically annotate both the reference and the translation,
...
taken alone, captures the crux of the sentence semantics.
The coverage of
these and other phenomena by HUME  make it possible to 
empirically determine 
(rather than stipulate), the relative importance of 
semantic structures for MT evaluation.
...
accidentally negated or in a slightly wrong tense). HMEANT annotation only allows
for a match or non-match between reference and translation predicates, with non-match
giving zero score for the whole frame.
In HUME, the verb is still present as a sub-unit of the
